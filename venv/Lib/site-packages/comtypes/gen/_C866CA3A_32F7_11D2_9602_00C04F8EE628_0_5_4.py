...
__all__ = [
    'SDTAudio', 'SPINTERFERENCE_NOISE', 'SPINTERFERENCE_TOOQUIET',
    'SpeechVoiceCategoryTTSRate', 'SPRECORESULTTIMES', 'SPEI_MIN_SR',
    'SPWT_LEXICAL', 'SVSFPurgeBeforeSpeak', 'SPSLMA',
    'DISPID_SPANumberOfElementsInResult', 'ISpeechRecoResultDispatch',
    'SPEI_PROPERTY_NUM_CHANGE', 'SPWT_DISPLAY',
    'Speech_Default_Weight', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'DISPID_SRRSaveToMemory', 'SPSHT_NotOverriden',
    'SAFTADPCM_44kHzMono', 'tagSPPROPERTYINFO', 'DISPID_SVSpeak',
    'DISPID_SpeechPhraseReplacements', 'eLEXTYPE_PRIVATE7',
    'DISPID_SRAudioInputStream', 'DISPID_SLPType',
    'DISPID_SDKGetlongValue', 'DISPID_SDKEnumKeys', 'SPWORDLIST',
    'SVP_12', 'DISPID_SGRSTransitions', 'DISPID_SVGetProfiles',
    'DISPID_SpeechLexicon', 'SPRULESTATE',
    'DISPID_SRCCmdMaxAlternates', 'SpeechMicTraining',
    'SVSFPersistXML', 'UINT_PTR', 'SPEI_TTS_AUDIO_LEVEL',
    'SDKLDefaultLocation', 'DISPID_SPEAudioSizeTime', 'SREStreamEnd',
    'SVESentenceBoundary', 'SpeechEngineConfidence', 'SGDSActive',
    'SGSEnabled', 'DISPID_SPRFirstElement', 'SREHypothesis',
    'DISPID_SVAudioOutputStream', 'DISPID_SGRClear', 'SRCS_Disabled',
    'LONG_PTR', 'DISPID_SpeechRecoResult', 'SVSFParseSapi',
    'ISpeechResourceLoader', 'SPEI_VOICE_CHANGE', 'SVEWordBoundary',
    'SpeechVoiceSkipTypeSentence',
    'SpeechGrammarRuleStateTransitionType', 'eLEXTYPE_PRIVATE6',
    'SPINTERFERENCE', 'SpeechInterference', 'SRAExport',
    'SpeechTokenIdUserLexicon', 'SPLO_STATIC', 'SpeechDiscardType',
    'SASPause', 'DISPID_SpeechGrammarRules', 'SREStateChange',
    'ISpeechLexiconWords', 'DISPID_SAEventHandle',
    'SAFT16kHz16BitStereo', 'DISPID_SDKCreateKey', 'SDTRule',
    'eLEXTYPE_PRIVATE19', 'SAFTCCITT_ALaw_11kHzStereo',
    'ISpeechTextSelectionInformation', 'SAFTADPCM_8kHzMono',
    'DISPID_SRGSetTextSelection', 'DISPID_SLGenerationId',
    'SITooSlow', 'SPCS_ENABLED', 'SPAO_RETAIN_AUDIO',
    'DISPID_SDKDeleteValue', 'SWPKnownWordPronounceable',
    'DISPID_SGRsAdd', 'DISPID_SPIReplacements', 'SPCT_DICTATION',
    ...
    'eLEXTYPE_PRIVATE13', 'eLEXTYPE_PRIVATE14', 'SpMemoryStream',
    'SPSHORTCUTPAIR', 'SASStop', 'DISPID_SVVolume',
    'DISPID_SpeechPhraseElements', 'DISPID_SBSRead', 'SPPS_RESERVED4',
    'SPSHT_OTHER', 'SAFT48kHz16BitMono', 'SPSNoun', 'SpeechWordType',
    'DISPID_SOTRemove', 'SAFT12kHz16BitStereo', 'ISpeechObjectToken',
    'SAFT12kHz8BitStereo', 'DISPID_SABIEventBias', 'DISPID_SGRName',
    'DISPID_SVResume', 'SVP_1', 'SPWORD', 'SPLEXICONTYPE',
    'DISPID_SRRTTickCount', 'SRAInterpreter', 'SVP_10',
    'eWORDTYPE_ADDED', 'DISPID_SAVolume', 'SAFTCCITT_uLaw_22kHzMono',
    'DISPID_SRGRules', 'DISPID_SRCERecognitionForOtherContext',
    'ISpResourceManager', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'DISPID_SRCreateRecoContext', 'SPPS_Verb', 'SPSERIALIZEDRESULT',
    'SDKLCurrentUser', 'DISPIDSPTSI_SelectionLength',
    'SpeechCategoryAudioOut', 'eLEXTYPE_PRIVATE8', 'SPPS_Noun',
    'ISpRecoContext', 'ISpLexicon', 'DISPID_SRCSetAdaptationData',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SpeechXMLRecoResult',
    'SpLexicon', 'SFTSREngine', 'DISPID_SRStatus', 'SPEI_PHONEME',
    'DISPID_SGRsDynamic', 'SGRSTTTextBuffer', 'DISPID_SLPsCount',
    'SVP_2', 'SPFILEMODE', 'DISPID_SVSVisemeId',
    'SpeechVoicePriority', 'tagSTATSTG', 'SAFT48kHz16BitStereo',
    'DISPID_SRGetFormat', 'SPEI_RESERVED1', 'SREPrivate',
    'ISpeechPhraseRule', 'DISPID_SPPsItem', 'SVP_0',
    'SPRST_INACTIVE_WITH_PURGE', 'eLEXTYPE_PRIVATE16', 'SPPHRASE',
    'SPVPRI_ALERT', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'SRTExtendableParse', 'DISPID_SpeechPhoneConverter',
    'ISpStreamFormatConverter', 'eLEXTYPE_PRIVATE4',
    'SpeechRuleState', 'IInternetSecurityMgrSite', 'SPVPRI_NORMAL',
    'SAFT44kHz8BitMono', 'SPDKL_LocalMachine', 'DISPID_SGRs_NewEnum',
    'SP_VISEME_5', 'DISPID_SPPs_NewEnum', 'DISPID_SOTs_NewEnum',
    'SVPOver', 'SpeechPropertyLowConfidenceThreshold',
    'SAFTGSM610_22kHzMono', 'ISpeechLexiconPronunciation',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'ISpeechMMSysAudio', 'SPSModifier', 'ISpeechRecoResultTimes',
    'eLEXTYPE_VENDORLEXICON', 'SpeechAudioVolume', 'SPCT_SUB_COMMAND',
    'DISPID_SOTCGetDataKey', 'SGDSInactive',
    'DISPID_SDKGetBinaryValue', 'SAFT24kHz16BitStereo',
    'SDTLexicalForm', 'SPRST_NUM_STATES', 'DISPID_SPIElements',
    'eLEXTYPE_USER_SHORTCUT', 'SGDisplay',
    'SpeechDictationTopicSpelling', 'DISPID_SpeechPhraseProperty',
    'DISPID_SRCEAudioLevel', 'ISpRecoContext2', 'DISPID_SPPChildren',
    'DISPID_SRCEStartStream', 'SGDSActiveWithAutoPause',
    'SpAudioFormat', 'DISPID_SRCEInterference',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SOTGetStorageFileName',
    'DISPID_SPPsCount', 'DISPID_SGRAddState', 'SSSPTRelativeToEnd',
    'SPEI_UNDEFINED', 'DISPID_SRRPhraseInfo', 'eLEXTYPE_MORPHOLOGY',
    'SpWaveFormatEx', 'SpeechPropertyResourceUsage',
    'SpeechFormatType', 'SGSDisabled', 'SREInterference',
    'SPEI_RESERVED6', 'DISPID_SRCVoicePurgeEvent',
    'ISpPhoneticAlphabetSelection', 'DISPID_SVEVoiceChange',
    'DISPID_SRCEPhraseStart', 'SpInprocRecognizer',
    'SPINTERFERENCE_TOOLOUD', 'SPXRO_Alternates_SML',
    'SGRSTTDictation', 'SAFTADPCM_44kHzStereo', 'ISpeechFileStream',
    'ISpPhraseAlt', '_RemotableHandle', 'SpeechGrammarTagWildcard',
    'DISPID_SVGetAudioInputs', 'SpeechVisemeType',
    'SAFT16kHz16BitMono', 'SRESoundEnd', 'ISpeechGrammarRule',
    'SPWAVEFORMATTYPE', 'SP_VISEME_14', 'SPWT_PRONUNCIATION',
    'DISPID_SRGCmdSetRuleIdState', 'SpeechDisplayAttributes',
    'DISPID_SABufferInfo', 'SpeechGrammarWordType',
    'SAFT8kHz8BitStereo', 'SAFT22kHz16BitStereo', 'ISpMMSysAudio',
    'DISPID_SPRs_NewEnum', 'DISPID_SVVoice', 'DISPID_SRCVoice',
    'SGRSTTEpsilon', 'DISPID_SRGRecoContext', 'SPCT_COMMAND',
    'SpeechCategoryAppLexicons', 'DISPID_SPEDisplayAttributes',
    'DISPID_SVEventInterests', 'ISpeechGrammarRuleStateTransition',
    'SVEVoiceChange', 'SpeechVisemeFeature', 'DISPID_SRCEBookmark',
    ...
    'SPPHRASEPROPERTY', 'SPFM_OPEN_READONLY', 'SAFT8kHz8BitMono',
    'DISPID_SPPFirstElement', 'SP_VISEME_2',
    'DISPID_SGRSTPropertyName', 'SPRECOCONTEXTSTATUS',
    'ISpeechObjectTokenCategory', 'SVP_4', 'SpMMAudioOut',
    'DISPID_SpeechObjectToken', 'ISpeechPhraseReplacements',
    'SPEI_END_INPUT_STREAM', 'SPINTERFERENCE_NOSIGNAL',
    'SDKLCurrentConfig', 'ISpXMLRecoResult', 'SRAONone',
    'SSTTWildcard', 'SpeechGrammarTagDictation', 'SFTInput',
    'ISpeechLexiconWord', 'SAFT32kHz8BitMono',
    'ISpeechLexiconPronunciations', 'DISPID_SVSLastBookmark',
    'DISPID_SAFType', 'DISPID_SRGDictationLoad',
    'DISPID_SRGCmdLoadFromResource', 'SPAS_CLOSED',
    'SAFT12kHz8BitMono', 'SPEI_WORD_BOUNDARY', 'STCLocalServer',
    'SP_VISEME_9', 'DISPID_SVSLastBookmarkId',
    'SpeechCategoryPhoneConverters', 'DISPID_SRCCreateGrammar',
    'SpShortcut', 'SPXRO_SML', 'SINone', 'DISPID_SOTGetAttribute',
    'DISPID_SGRsCommit', 'DISPID_SpeechCustomStream',
    'ISpeechWaveFormatEx', 'DISPIDSPTSI_ActiveOffset',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SRCEventInterests',
    'DISPID_SRCCreateResultFromMemory', 'SAFTCCITT_ALaw_11kHzMono',
    'SAFT32kHz16BitMono', 'ISpGrammarBuilder',
    'DISPID_SGRSAddWordTransition', 'eLEXTYPE_PRIVATE18',
    'SVEPrivate', 'SAFTADPCM_22kHzStereo', 'DISPID_SWFEFormatTag',
    'DISPID_SPRuleChildren', 'DISPID_SRCERecognizerStateChange',
    'DISPID_SGRsCount', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'DISPID_SVSRunningState', 'DISPID_SOTCEnumerateTokens',
    'SP_VISEME_18', 'DISPID_SRDisplayUI', 'SASClosed',
    'DISPID_SpeechWaveFormatEx', 'SECFEmulateResult',
    'DISPID_SRCEFalseRecognition', 'DISPID_SPAsCount',
    'SPFM_NUM_MODES', 'SVF_Emphasis', 'eLEXTYPE_RESERVED8',
    'SVSFNLPMask', 'SpeechWordPronounceable', 'SP_VISEME_7',
    'DISPID_SASCurrentSeekPosition', 'SPPROPERTYINFO',
    'DISPID_SDKEnumValues', 'DISPID_SRGCommit',
    'DISPID_SVSCurrentStreamNumber', 'SPPARTOFSPEECH', 'ISpStream',
    'SWTDeleted', 'SPPS_LMA', 'SVP_14', 'SVEViseme',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SVWaitUntilDone',
    'DISPID_SpeechRecognizer', 'SRADynamic', 'DISPID_SRRecognizer',
    'SpeechAudioFormatType', 'SBOPause', 'DISPID_SVSPhonemeId',
    'IEnumSpObjectTokens', 'SpeechTokenShellFolder', 'SPWORDTYPE',
    'SPWF_SRENGINE', 'STSF_FlagCreate', 'ISpeechCustomStream',
    'DISPID_SOTCDefault', 'SVP_7', 'SPEI_MAX_TTS', 'SPRST_INACTIVE',
    'ISpeechObjectTokens', 'SPAS_STOP', 'SVEBookmark',
    'DISPID_SPERetainedStreamOffset', 'SPBOOKMARKOPTIONS',
    'SPWORDPRONUNCIATIONLIST', 'ISpRecoGrammar2',
    'SSSPTRelativeToCurrentPosition', 'SPEI_HYPOTHESIS', 'SASRun',
    'DISPID_SpeechMemoryStream', 'SVF_None', 'DISPID_SGRSTsItem',
    'ISpeechRecoResult', 'DISPID_SLGetWords', 'SPAS_PAUSE',
    'SAFT8kHz16BitStereo', 'DISPID_SVSyncronousSpeakTimeout',
    'DISPID_SPCLangId', 'DISPID_SGRsFindRule',
    'DISPID_SGRInitialState', 'SpeechRuleAttributes', 'SVP_8',
    'DISPID_SpeechAudio', 'SGDSActiveUserDelimited',
    'SpeechPropertyResponseSpeed', 'DISPID_SRCState', 'ISpProperties',
    'DISPID_SRCEEndStream', 'eLEXTYPE_PRIVATE15',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SPRuleId',
    'SP_VISEME_17', 'ISpeechAudioBufferInfo', 'SPGS_ENABLED',
    'DISPID_SRCEPropertyNumberChange',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SVP_5',
    'SGSExclusive', 'DISPID_SRIsShared', 'SAFTGSM610_44kHzMono',
    'DISPID_SLWs_NewEnum', 'DISPID_SPIGetDisplayAttributes',
    'SAFTCCITT_ALaw_8kHzMono', 'SVSFIsFilename',
    'DISPID_SWFEBitsPerSample', 'SpeechCategoryRecoProfiles',
    'DISPID_SRGDictationSetState', 'SPEI_START_SR_STREAM',
    ...
    'DISPID_SWFEExtraData', 'DISPID_SRCERequestUI',
    'DISPID_SMSADeviceId', 'DISPID_SVGetVoices', 'SpeechTokenContext',
    'SPEI_SR_AUDIO_LEVEL', 'DISPID_SVGetAudioOutputs',
    'SpeechAudioState', 'DISPID_SGRSTsCount', 'DISPID_SOTsCount',
    'SPBO_AHEAD', 'SECNormalConfidence', 'SPXMLRESULTOPTIONS',
    'DISPID_SPIAudioSizeBytes', 'ISpRecognizer3', 'DISPID_SPACommit',
    'DISPID_SABIMinNotification', 'SpeechRegistryUserRoot',
    'SGLexicalNoSpecialChars', 'DISPID_SPRText',
    'DISPID_SRGetPropertyNumber',
    'SpeechPropertyComplexResponseSpeed', 'SP_VISEME_6', 'ISpPhrase',
    'SGPronounciation', 'SpeechBookmarkOptions', 'SREAdaptation',
    'SPSUnknown', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'SPEI_SR_BOOKMARK', 'SpeechLoadOption', 'SPGRAMMARWORDTYPE',
    'DISPID_SLAddPronunciationByPhoneIds', 'SDA_No_Trailing_Space',
    'SECHighConfidence', 'SECLowConfidence', 'SAFT32kHz16BitStereo',
    'ISpeechPhraseInfo', 'DISPID_SGRAttributes', 'eLEXTYPE_APP',
    'SAFTCCITT_uLaw_44kHzMono', 'SpeechAudioProperties',
    'ISpNotifySink', 'SpeechStreamSeekPositionType', 'SVP_6',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SP_VISEME_15',
    'SpeechPropertyNormalConfidenceThreshold', 'ISpeechAudio',
    'SPGRAMMARSTATE', 'SPAR_Low', 'IInternetSecurityManager',
    'SpFileStream', 'SPGS_EXCLUSIVE', 'DISPID_SPRDisplayAttributes',
    'DISPID_SpeechAudioBufferInfo', 'SpeechRecoEvents',
    'SpObjectTokenCategory', 'ISpeechGrammarRuleStateTransitions',
    'DISPID_SLPPhoneIds', 'ISpeechPhraseAlternates',
    'SPCT_SUB_DICTATION', 'ISpVoice', 'SAFTNoAssignedFormat',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SSFMOpenForRead',
    'SpeechPartOfSpeech', 'DISPID_SGRAddResource',
    'DISPID_SOTIsUISupported', 'DISPID_SPAStartElementInResult',
    'DISPID_SGRSTPropertyId', 'SVP_18', 'ISpRecognizer2',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'ISpShortcut',
    'DISPID_SFSClose', 'SVPAlert', 'SpeechTokenKeyAttributes',
    'SPAR_High', 'SREAudioLevel', 'DISPID_SPPId',
    'DISPID_SPRuleConfidence', 'SVP_16', 'DISPID_SPCIdToPhone',
    'SPVPRIORITY', 'SpeechRecoProfileProperties',
    'DISPID_SRSCurrentStreamNumber',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SpeechRunState', 'SpSharedRecognizer',
    'SpTextSelectionInformation', 'DISPID_SASCurrentDevicePosition',
    'DISPID_SRGDictationUnload', 'SPEI_ADAPTATION',
    'ISpeechPhraseReplacement', 'SVP_19', 'SVP_21', 'DISPID_SASState',
    'SPSNotOverriden', 'DISPID_SOTCreateInstance',
    'DISPID_SRAudioInput', 'ISpeechPhraseProperty', 'DISPID_SGRSRule',
    'SAFT16kHz8BitMono', 'DISPID_SGRId', 'SLODynamic',
    'DISPID_SPRuleFirstElement', 'SAFT16kHz8BitStereo',
    'DISPID_SRProfile', 'SVSFParseAutodetect', 'SRERecognition',
    'SPLO_DYNAMIC', 'DISPID_SVSkip', 'DISPID_SVEWord',
    'DISPID_SRCESoundStart', 'DISPID_SRCERecognition', 'SpVoice',
    'SREBookmark', 'DISPID_SPPParent',
    ...
    'SPWORDPRONUNCIATION', 'DISPID_SPIAudioSizeTime',
    'ISpeechMemoryStream', 'DISPID_SPEAudioTimeOffset', 'SVPNormal',
    'DISPID_SPPNumberOfElements', 'DISPID_SGRSTPropertyValue',
    'DISPID_SpeechFileStream', 'SREPropertyStringChange',
    'DISPID_SRRTStreamTime', 'DISPID_SPRuleParent',
    'SPFM_CREATE_ALWAYS', 'DISPID_SpeechVoice', 'DISPID_SRGReset',
    'SpeechAudioFormatGUIDText', 'SAFT22kHz8BitStereo', 'SPEVENT',
    'DISPID_SPEs_NewEnum', 'DISPID_SpeechLexiconWords', 'SGRSTTWord',
    'IEnumString', 'DISPID_SPPName', 'SECFIgnoreWidth',
    'DISPID_SRGCmdSetRuleState', 'SPPS_RESERVED1',
    'DISPID_SRGIsPronounceable', 'eLEXTYPE_PRIVATE10',
    'ISpObjectWithToken', 'DISPID_SABIBufferSize',
    'DISPID_SPPEngineConfidence', 'SAFTCCITT_uLaw_8kHzMono',
    'SPSHORTCUTTYPE', 'SAFTCCITT_ALaw_8kHzStereo', 'SVSFDefault',
    'ISpeechVoiceStatus', 'DISPID_SVPause', 'DISPID_SPCPhoneToId',
    'SECFIgnoreKanaType', 'ISpeechVoice',
    'SWPUnknownWordUnpronounceable', 'SPINTERFERENCE_NONE',
    'DISPID_SWFEChannels', 'SPEI_VISEME', 'SAFT24kHz8BitStereo',
    'SAFTCCITT_ALaw_44kHzStereo', 'SPSSuppressWord',
    'DISPID_SMSAMMHandle', 'SP_VISEME_21', 'eLEXTYPE_RESERVED4',
    ...
    'DISPID_SRRSpeakAudio', 'SP_VISEME_13', 'WAVEFORMATEX',
    'SPAUDIOBUFFERINFO', 'SAFTCCITT_uLaw_44kHzStereo',
    'SPADAPTATIONRELEVANCE', 'DISPID_SVSInputWordLength',
    'DISPID_SpeechDataKey', 'DISPID_SGRSTType',
    'DISPID_SAFGetWaveFormatEx', 'DISPID_SDKOpenKey',
    'SpeechLexiconType', 'SVP_20', 'DISPID_SVEViseme',
    'DISPID_SDKGetStringValue', 'SECFDefault',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SRCESoundEnd',
    'DISPID_SVPriority', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'DISPID_SpeechGrammarRuleState', 'SSFMCreateForWrite',
    'SPBO_NONE', 'DISPID_SVEEnginePrivate', 'SRAImport',
    'Speech_StreamPos_RealTime', 'SRSInactive', 'DISPID_SBSSeek',
    'SpPhoneConverter', 'DISPID_SpeechRecoContextEvents', 'SGLexical',
    'SpeechRegistryLocalMachineRoot', 'SRSInactiveWithPurge',
    'ISpRecognizer', 'SPWF_INPUT', 'eLEXTYPE_PRIVATE5', 'SVP_13',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SRRAudioFormat',
    'STSF_CommonAppData', 'DISPID_SPRsItem', 'SPAS_RUN',
    'SPEI_TTS_BOOKMARK', 'SAFT24kHz16BitMono', 'SPRS_INACTIVE',
    'DISPID_SOTDisplayUI', 'SPPS_Function', 'SRERequestUI',
    'DISPID_SPAs_NewEnum', 'SREAllEvents', 'SPEI_FALSE_RECOGNITION',
    'SPPHRASERULE', 'DISPID_SFSOpen', 'SVSFUnusedFlags',
    'SPSHT_EMAIL', 'SPCS_DISABLED', 'DISPID_SLWLangId',
    'SPEI_RECOGNITION', 'DISPID_SOTGetDescription',
    'DISPID_SVEStreamEnd', 'DISPID_SDKSetBinaryValue', 'SRTReSent',
    'SRSActive', 'ISpeechRecoResult2', 'SPPS_RESERVED3',
    'DISPID_SVSpeakStream', 'SAFT11kHz16BitStereo', 'ISpRecoGrammar',
    'DISPID_SpeechLexiconPronunciation', 'SRSEIsSpeaking',
    'DISPID_SAStatus', 'DISPID_SGRSTNextState',
    'DISPID_SVSInputWordPosition', 'SAFT22kHz8BitMono',
    'DISPID_SVSInputSentencePosition', 'SpeechPropertyAdaptationOn',
    'DISPID_SVStatus', 'ISpeechPhoneConverter',
    'Speech_Max_Word_Length', 'DISPID_SRCBookmark',
    'SPFM_OPEN_READWRITE', '__MIDL_IWinTypes_0009',
    'Speech_Max_Pron_Length', 'SAFTDefault',
    'SPRS_ACTIVE_USER_DELIMITED', 'SREStreamStart',
    'SpUnCompressedLexicon', 'DISPID_SpeechPhraseBuilder',
    'SPEI_RESERVED2', 'SpMMAudioIn', 'DISPID_SVEStreamStart',
    'eLEXTYPE_PRIVATE17', 'SAFTNonStandardFormat', 'DISPID_SBSWrite',
    'SPEI_RESERVED3', 'DISPID_SDKSetStringValue',
    'DISPID_SpeechPhraseAlternate', 'ISpeechPhraseAlternate',
    'SPTEXTSELECTIONINFO', 'SPAUDIOSTATUS', 'SPLOADOPTIONS',
    'SPEI_RECO_OTHER_CONTEXT', 'DISPID_SADefaultFormat',
    'SDTAlternates', 'SP_VISEME_10', 'DISPID_SGRsCommitAndSave',
    'DISPID_SVDisplayUI', 'SAFTGSM610_8kHzMono',
    'DISPID_SRCEPropertyStringChange',
    'DISPID_SpeechPhraseAlternates', 'SSTTTextBuffer',
    'SpeechCategoryRecognizers', 'eLEXTYPE_PRIVATE2', 'SPSMF_UPS',
    'SPPS_SuppressWord', 'SP_VISEME_8', 'DISPID_SASNonBlockingIO',
    'SWTAdded', 'ISpObjectTokenCategory', 'SpeechGrammarState',
    'DISPID_SMSALineId', 'SpeechCategoryAudioIn',
    'ISpeechGrammarRules', 'DISPID_SPRsCount', 'SRCS_Enabled',
    'DISPID_SRGCmdLoadFromFile', 'SGRSTTRule', 'SRTStandard',
    'DISPID_SDKDeleteKey', 'SPEI_RESERVED5', 'DISPID_SRCEHypothesis',
    'DISPID_SVESentenceBoundary', 'SPFM_CREATE',
    'DISPID_SPERequiredConfidence', 'SAFT48kHz8BitStereo',
    'DISPID_SRGSetWordSequenceData', 'DISPID_SLPLangId',
    'DISPID_SRCRequestedUIType', 'SP_VISEME_0', 'SRTEmulated',
    'DISPID_SPRuleNumberOfElements', 'ISpNotifyTranslator',
    'DISPID_SPARecoResult', 'DISPID_SPEAudioStreamOffset',
    'SpeechTokenKeyUI', 'SGRSTTWildcard', 'SPGS_DISABLED',
    'SRTSMLTimeout', 'SPEI_RECO_STATE_CHANGE', 'ISpeechLexicon',
    'DISPID_SVSLastStreamNumberQueued', 'SLOStatic',
    'DISPID_SVEAudioLevel', 'DISPID_SRIsUISupported', 'SpObjectToken',
    'SPEI_SOUND_END', 'SPAR_Unknown',
    'DISPID_SGRSAddSpecialTransition', 'SITooLoud',
    'ISpeechPhraseProperties', 'SSTTDictation', 'SVP_15',
    'SpeechSpecialTransitionType', 'eLEXTYPE_PRIVATE11',
    'Speech_StreamPos_Asap', 'SPPS_Noncontent', 'SP_VISEME_20',
    'ISpObjectToken', 'ISpeechAudioStatus', 'ISpEventSource',
    'DISPID_SpeechPhraseProperties', 'DISPID_SMSGetData',
    'SPPS_Interjection', 'SVSFNLPSpeakPunc',
    'DISPID_SRCEEnginePrivate', 'DISPID_SOTId',
    'SDA_Consume_Leading_Spaces', 'SPEI_SOUND_START',
    'DISPID_SpeechPhraseRules', 'DISPID_SGRsItem', 'DISPID_SPAsItem',
    'DISPID_SRRTimes', 'SDTDisplayText', 'IStream',
    'SAFT12kHz16BitMono', 'DISPID_SPRulesItem', 'DISPID_SPEsCount',
    'SpPhoneticAlphabetConverter', 'DISPID_SPPValue', 'SPVISEMES',
    'DISPID_SRSCurrentStreamPosition', 'SVSFlagsAsync',
    'SAFT11kHz16BitMono', 'SVEStartInputStream', 'DISPID_SVRate',
    'SAFT11kHz8BitMono', 'SREPhraseStart', 'SpMMAudioEnum',
    'DISPID_SVSLastResult', 'SpStreamFormatConverter',
    'SpCompressedLexicon', 'SpeechGrammarTagUnlimitedDictation',
    'DISPID_SGRSTText', 'SpStream', 'DISPID_SOTsItem',
    ...
    'DISPID_SRGetRecognizers', 'SPSTREAMFORMATTYPE', 'SAFTText',
    'DISPID_SpeechObjectTokens', 'DISPID_SRCPause',
    'ISpeechRecognizer', 'DISPIDSPTSI_ActiveLength',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SASetState',
    'SVSFParseSsml', 'eLEXTYPE_PRIVATE20', 'eLEXTYPE_RESERVED7',
    'SITooFast', 'SpeechTokenKeyFiles', 'SpeechCategoryVoices',
    'DISPID_SRCResume', 'SAFT48kHz8BitMono', 'SPRECOGNIZERSTATUS',
    'SpCustomStream', 'SAFTCCITT_ALaw_22kHzMono', 'SRATopLevel',
    'DISPID_SpeechGrammarRuleStateTransition',
    'ISpeechRecognizerStatus', 'eLEXTYPE_LETTERTOSOUND',
    'SPRS_ACTIVE', 'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SBSFormat', 'SpeechRetainedAudioOptions',
    'SpeechAudioFormatGUIDWave', 'DISPID_SpeechAudioFormat',
    'SpeechEngineProperties', 'SRSActiveAlways',
    'DISPID_SRSetPropertyNumber', 'DISPID_SRGCmdLoadFromObject',
    'SPAUDIOSTATE', 'eLEXTYPE_USER', 'STCRemoteServer',
    'SSFMOpenReadWrite', 'ISpDataKey', 'SDTPronunciation',
    'DISPID_SRCRecognizer', 'DISPID_SRCEAdaptation', 'SDTReplacement',
    'SPEVENTENUM', 'DISPID_SRRTLength', 'DISPID_SRGCmdLoadFromMemory',
    ...
    'DISPID_SRState', 'DISPID_SPIGrammarId', 'SVP_11',
    'SAFTExtendedAudioFormat', 'SP_VISEME_12', 'ISpSerializeState',
    'ISpeechGrammarRuleState', 'DISPID_SPRuleName', 'SPBO_PAUSE',
    'eWORDTYPE_DELETED', 'SECFNoSpecialChars',
    'SpeechRecognitionType', 'DISPID_SRGetPropertyString',
    'SPCONTEXTSTATE', 'DISPID_SWFEAvgBytesPerSec', 'DISPID_SLWType',
    'ISequentialStream', 'SpSharedRecoContext', 'SPSFunction',
    'DISPID_SRGId', 'SBONone', 'SP_VISEME_16',
    ...
    'DISPID_SWFEBlockAlign', 'SDA_One_Trailing_Space', 'ISpEventSink',
    'SAFTADPCM_11kHzStereo', '_SPAUDIOSTATE', 'SPCATEGORYTYPE',
    'DISPID_SpeechPhraseRule', 'DISPID_SOTCSetId',
    'SAFTCCITT_uLaw_8kHzStereo', 'SPDKL_DefaultLocation',
    'ISpeechBaseStream', 'DISPID_SRRTOffsetFromStart', 'SP_VISEME_3',
    'DISPID_SRRSetTextFeedback', 'SPPS_Modifier',
    '_ISpeechVoiceEvents', 'STCInprocHandler', 'ISpeechAudioFormat',
    'SP_VISEME_1', 'SRTAutopause', 'SPEI_MIN_TTS',
    'SRERecoOtherContext', 'eLEXTYPE_RESERVED10',
    'DISPID_SLPs_NewEnum', 'DISPID_SLWsItem', 'SVP_9',
    'SAFT11kHz8BitStereo', 'DISPID_SAFGuid', 'SDTProperty',
    'DISPID_SRSClsidEngine', 'SAFTCCITT_ALaw_44kHzMono',
    'DISPID_SRRAudio', 'SITooQuiet', 'DISPID_SMSSetData', 'SPAO_NONE',
    'SPSERIALIZEDPHRASE', 'DISPID_SVSpeakCompleteEvent',
    'eLEXTYPE_RESERVED9', 'DISPID_SVAudioOutput',
    'DISPID_SPELexicalForm', 'SAFT22kHz16BitMono',
    'DISPID_SpeechMMSysAudio', 'DISPID_SLWPronunciations',
    'DISPID_SRRGetXMLErrorInfo', 'SpeechUserTraining', 'SVSFIsNotXML',
    'SpeechAllElements', 'DISPID_SRCRetainedAudio', 'STSF_AppData',
    'SPPS_Unknown', 'DISPID_SPERetainedSizeBytes',
    'SPEVENTSOURCEINFO', 'SAFTADPCM_8kHzStereo', 'STCAll',
    'DISPID_SRSSupportedLanguages', 'ISpPhoneticAlphabetConverter',
    'SVP_17', 'ISpRecoResult', 'DISPID_SGRSTRule',
    'DISPID_SPILanguageId', 'SVEEndInputStream', 'SPBO_TIME_UNITS',
    'SpPhraseInfoBuilder', 'DISPID_SLPSymbolic',
    'DISPID_SGRSTs_NewEnum', 'DISPID_SPIRule', 'ISpeechRecoContext',
    'SP_VISEME_4', 'DISPID_SPIStartTime', 'SPVOICESTATUS',
    'SP_VISEME_11', 'DISPID_SPRules_NewEnum',
    'DISPID_SPEEngineConfidence', 'SVF_Stressed',
    'DISPID_SPRulesCount', 'SVP_3', 'SAFT8kHz16BitMono',
    'DISPIDSPTSI_SelectionOffset', 'SAFT44kHz8BitStereo', 'SINoise',
    'DISPID_SpeechRecoContext', 'SVEAudioLevel', 'SPRECOSTATE',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SPVPRI_OVER', 'SPSVerb',
    'SDTAll', 'STSF_LocalAppData', 'SPEI_START_INPUT_STREAM',
    'DISPID_SGRSTWeight', 'ISpeechRecoGrammar', 'SVSFVoiceMask',
    'SPINTERFERENCE_TOOSLOW', 'DISPID_SOTRemoveStorageFileName',
    'SECFIgnoreCase', 'SREFalseRecognition', 'ISpPhoneConverter',
    'DISPID_SLAddPronunciation',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'ISpeechPhraseElement',
    'ISpStreamFormat', 'DISPID_SOTDataKey', 'DISPID_SRRAlternates',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SDA_Two_Trailing_Spaces',
    'SPEI_SR_PRIVATE', 'DISPID_SPRNumberOfElements',
    'SAFT44kHz16BitMono', 'SSFMCreate', 'SPSInterjection',
    'SINoSignal', 'DISPID_SpeechRecognizerStatus',
    'eLEXTYPE_PRIVATE1', 'STCInprocServer', 'DISPID_SPIEngineId',
    'SPEI_END_SR_STREAM', 'DISPID_SLPPartOfSpeech',
    'SAFTADPCM_22kHzMono', 'SRAORetainAudio', 'DISPID_SOTCategory',
    'ISpeechDataKey', 'ISpAudio', 'DISPID_SPISaveToMemory',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SRRGetXMLResult',
    'DISPID_SCSBaseStream', 'DISPID_SpeechLexiconProns',
    'SPEI_INTERFERENCE', 'DISPID_SPEDisplayText',
    'DISPID_SRSetPropertyString', 'DISPID_SOTSetId',
    'SDKLLocalMachine', 'DISPID_SPAPhraseInfo', 'DISPID_SLPsItem',
    'DISPID_SRGState', 'DISPID_SAFSetWaveFormatEx',
    'SpeechVoiceSpeakFlags', 'DISPID_SVIsUISupported',
    'DISPID_SRSAudioStatus', 'eLEXTYPE_PRIVATE9', 'ISpRecoCategory',
    'SAFT44kHz16BitStereo', 'DISPID_SPPBRestorePhraseFromMemory',
    'SPPHRASEREPLACEMENT', 'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SRARoot',
    'SpInProcRecoContext', 'SRESoundStart', 'SVEAllEvents',
    'DISPID_SpeechVoiceStatus', 'SPDATAKEYLOCATION',
    'SPINTERFERENCE_LATENCY_WARNING', 'SVSFParseMask',
    'SSSPTRelativeToStart', 'SVEPhoneme', '_ISpeechRecoContextEvents',
    'SPWORDPRONOUNCEABLE', 'DISPID_SpeechVoiceEvent',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SpeechLexiconWord',
    'eLEXTYPE_PRIVATE3', 'SPPHRASEELEMENT', 'DISPIDSPRG',
    'DISPID_SpeechObjectTokenCategory', 'SpeechAddRemoveWord',
    'SPEI_TTS_PRIVATE', 'SPEI_MAX_SR', 'DISPID_SLWWord',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SRSEDone',
    'DISPID_SVAlertBoundary', 'SPSEMANTICFORMAT', 'DISPID_SLWsCount',
    'DISPID_SLRemovePronunciation', 'SPPS_RESERVED2',
    'ISpeechPhraseElements', 'SpeechTokenValueCLSID', 'DISPID_SOTCId',
    'SPRULE', 'SPCT_SLEEP', 'SAFT32kHz8BitStereo',
    'SpResourceManager', 'SPBINARYGRAMMAR', 'SPEI_SR_RETAINEDAUDIO',
    'SPSEMANTICERRORINFO', 'DISPID_SpeechPhraseElement',
    'SPAR_Medium', 'ISpeechPhraseRules', 'SPEI_REQUEST_UI',
    'SPRST_ACTIVE', 'SP_VISEME_19', 'SLTApp', 'SpeechVoiceEvents',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SPDKL_CurrentConfig',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SVSInputSentenceLength',
    'eLEXTYPE_PRIVATE12', 'ISpeechXMLRecoResult', 'SLTUser',
    'DISPID_SPIAudioStreamPosition', 'DISPID_SPPConfidence',
    'SPSHORTCUTPAIRLIST', 'SPPS_NotOverriden', 'DISPIDSPTSI',
    'DISPID_SpeechGrammarRule', 'SWPUnknownWordPronounceable',
    'SPAUDIOOPTIONS', 'DISPID_SPEPronunciation',
